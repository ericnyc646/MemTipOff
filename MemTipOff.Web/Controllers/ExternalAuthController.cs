...
using MemTipOff.Web.Authentication;
using MemTipOff.Web.Helpers;
using MemTipOff.Web.Models;
using MemTipOff.Web.Models.FacebookModels;
...
namespace MemTipOff.Web.Controllers
{
    ...
    public class ExternalAuthController : ControllerBase
    {
        ...
        public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<AppUser> userManager, AuthDbContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
        {
